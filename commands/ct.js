...
exports.run = (client, message, args) => {
    ...
    var locationChannel = globalClient.channels.get(config.locations.CT);
    ...
    // to false
    var Monitor = new dirwatch.DirectoryWatcher("Z:\\08A-Processed", true);
    ...
    console.log("Finished Scanning CT Folder!");
};