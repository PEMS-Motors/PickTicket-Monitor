...
exports.run = (client, message, args) => {
    ...
    var locationChannel = globalClient.channels.get(config.locations.MO);
    ...
    // to false
    var Monitor = new dirwatch.DirectoryWatcher("Z:\\04A-Processed", true);
    ...
    console.log("Finished Scanning MO Folder!");
};