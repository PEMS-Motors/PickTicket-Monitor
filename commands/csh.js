...
exports.run = (client, message, args) => {
    ...
    var locationChannel = globalClient.channels.get(config.locations.CSH);
    ...
    // to false
    var Monitor = new dirwatch.DirectoryWatcher("Z:\\CSH", true);
    ...
    console.log("Finished Scanning CSH Folder!");
};