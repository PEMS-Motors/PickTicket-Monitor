...
exports.run = (client, message, args) => {
    ...
    var locationChannel = globalClient.channels.get(config.locations.TN);
    ...
    // to false
    var Monitor = new dirwatch.DirectoryWatcher("Z:\\13A-Processed", true);
    ...
    console.log("Finished Scanning TN Folder!");
};