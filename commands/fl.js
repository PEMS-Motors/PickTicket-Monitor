...
exports.run = (client, message, args) => {
    ...
    var locationChannel = globalClient.channels.get(config.locations.FL);
    ...
    // to false
    var Monitor = new dirwatch.DirectoryWatcher("Z:\\10A-Processed", true);
    ...
    console.log("Finished Scanning FL Folder!");
};