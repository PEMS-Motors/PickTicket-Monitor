...
module.exports = {
    command_nc: function () {
        ...
        var locationChannel = globalClient.channels.get(config.locations.NC);
        ...
        // to false
        var Monitor = new dirwatch.DirectoryWatcher(config.filepaths.NC, true);
        ...
        console.log("NC Scanning has started");
    }
};